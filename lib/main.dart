...
import 'package:projet_app/splash_screen.dart';
//import 'package:projet_app/pages/map_inside_listview.dart';
//import 'package:projet_app/pages/network_tile_provider.dart';
...
void main(){
  runApp(MaterialApp(home: projet_App(),));
}

class projet_App extends StatelessWidget {//classe personnalisee qui etend un widget un widget de base
  //widget qui ne peut pas changer d'etat
  const projet_App({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(//widget racine
      debugShowCheckedModeBanner: false,//pour desactiver le debug qui montre que l'appli est entrain de deboguer
      home: SplashScreen(),
